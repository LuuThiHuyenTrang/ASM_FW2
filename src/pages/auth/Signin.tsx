...
import { useAuthSignInMutation } from '@/hooks/useAuthSignInMutation'
...
const SigninPage = () => {
    ...
    const { form, onSubmit } = useAuthSignInMutation({
        action: 'SIGNIN',
        onSuccess: () => {
            toast({
    ...
    return (
        <>
            ...
            <div className='container relative hidden h-[800px] flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0'>
                <Link to='/signup' className={cn({ variant: 'ghost' }, 'absolute right-4 top-4 md:right-8 md:top-8')}>
                    LOGIN
                </Link>
